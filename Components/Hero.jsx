        ...
        <div className="relative bg-opacity-75 backgroundMain">
          <svg
           ...
           >  
            ...
            162.5 916 162.5C796 162.5 676 162.5 556 162.5C436 162.5 316 162.5 196 162.5C76 162.5 -4 162.5 -104 162.5H-164V13Z"
            />
          </svg>
            ...
            <div className="flex flex-col items-center justify-between xl:flex-row">
              <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none">
                  ...
                  Crowd Funding CK</h2>
                  <p className="max-w-xl mb-4 text-base text-grey-200 md:text-lg">
                    akjnsbdhibiklvbefvkjbhkevbhkfvbfhkvbkhbvhkbhkbvshjmb 
                  </p>
                  <a
                     href="/"
                     aria-label=""
                     ...
                     >
                      ...
                      <svg 
                         ...
                         >
                          ...
                          1,0,1,0,1.414l5-5A1,1,0,0,0,9.707,5.293Z" />
                       </svg>   
                     </a>
                   </div>  
